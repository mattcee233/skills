...
const STUB_SOURCE = path.join(__dirname, 'stub-pi.js');

function makeStubPi(t, initialConfig = {}) {
  const dir = fs.mkdtempSync(path.join(os.tmpdir(), 'teach-stub-pi-'));
  const scriptPath = path.join(dir, 'stub-pi.js');
